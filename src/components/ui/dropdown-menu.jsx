...
const DropdownMenuSubTrigger = React.forwardRef(
  ...
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default gap-2 select-none items-center rounded-md px-2 py-1.5 text-sm outline-none focus:bg-emerald-50 focus:text-[#1B4332] data-[state=open]:bg-emerald-50 data-[state=open]:text-[#1B4332] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
      inset && "pl-8",
      className
    )}
    {...props}>
...
const DropdownMenuContent = React.forwardRef(
  ...
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden rounded-xl border border-stone-200 bg-white p-1 text-stone-950 shadow-md",
...
const DropdownMenuItem = React.forwardRef(
  ...
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center gap-2 rounded-md px-2 py-1.5 text-sm outline-none transition-colors focus:bg-emerald-50 focus:text-[#1B4332] data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&>svg]:size-4 [&>svg]:shrink-0",
      inset && "pl-8",
      className
    )}
    {...props} />
